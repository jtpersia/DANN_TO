...
NLs2 = net.outputs{(archLayer+1)}.processSettings{1};
...
save('NLstructOW.mat', 'NLs2')
save('NLIW1.txt','IW','-ascii')
save('NLLW1.txt','LW','-ascii')
save('NLLW2.txt','LW2','-ascii')
save('NLb1.txt','b1','-ascii')
save('NLb2.txt','b2','-ascii')
save('NLb3.txt','b3','-ascii')
save('NLnorm.txt', 'normFactor','-ascii')
