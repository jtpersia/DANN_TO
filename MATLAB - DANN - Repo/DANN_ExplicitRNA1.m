...
RNA1s2 = net.outputs{(archLayer+1)}.processSettings{1};
...
save('RNA1structOW.mat', 'RNA1s2')

save('RNA1IW1.txt','IW','-ascii')
save('RNA1LW1.txt','LW','-ascii')
save('RNA1LW2.txt','LW2','-ascii')
save('RNA1LW3.txt','LW3','-ascii')

save('RNA1b1.txt','b1','-ascii')
save('RNA1b2.txt','b2','-ascii')
save('RNA1b3.txt','b3','-ascii')
save('RNA1b4.txt','b4','-ascii')

save('RNA1norm.txt', 'normFactor','-ascii')