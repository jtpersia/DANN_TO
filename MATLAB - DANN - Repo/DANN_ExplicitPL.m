...
PLs2 = net.outputs{(archLayer+1)}.processSettings{1};
...
save('PLstructOW.mat', 'PLs2')

save('PLIW1.txt','IW','-ascii')
save('PLLW1.txt','LW','-ascii')
save('PLLW2.txt','LW2','-ascii')

save('PLb1.txt','b1','-ascii')
save('PLb2.txt','b2','-ascii')
save('PLb3.txt','b3','-ascii')

save('PLnorm.txt', 'normFactor','-ascii')
% 
