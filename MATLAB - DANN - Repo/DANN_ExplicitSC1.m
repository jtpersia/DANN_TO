...
SC1s2 = net.outputs{(archLayer+1)}.processSettings{1};
...
save('SC1structOW.mat', 'SC1s2')

save('SC1IW1.txt','IW','-ascii')
save('SC1LW1.txt','LW','-ascii')
save('SC1LW2.txt','LW2','-ascii')
save('SC1LW3.txt','LW3','-ascii')
save('SC1LW4.txt','LW4','-ascii')
save('SC1LW5.txt','LW5','-ascii')
save('SC1LW6.txt','LW6','-ascii')

save('SC1b1.txt','b1','-ascii')
save('SC1b2.txt','b2','-ascii')
save('SC1b3.txt','b3','-ascii')
save('SC1b4.txt','b4','-ascii')
save('SC1b5.txt','b5','-ascii')
save('SC1b6.txt','b6','-ascii')
save('SC1b7.txt','b7','-ascii')

save('SC1norm.txt', 'normFactor','-ascii')