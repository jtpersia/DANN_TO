...
SA1s2 = net.outputs{(archLayer+1)}.processSettings{1};
...
save('SA1structOW.mat', 'SA1s2')

save('SA1IW1.txt','IW','-ascii')
save('SA1LW1.txt','LW','-ascii')
save('SA1LW2.txt','LW2','-ascii')
save('SA1LW3.txt','LW3','-ascii')
save('SA1LW4.txt','LW4','-ascii')
save('SA1LW5.txt','LW5','-ascii')
save('SA1LW6.txt','LW6','-ascii')
save('SA1LW7.txt','LW7','-ascii')
save('SA1LW8.txt','LW8','-ascii')
save('SA1LW9.txt','LW9','-ascii')
save('SA1LW10.txt','LW10','-ascii')

save('SA1b1.txt','b1','-ascii')
save('SA1b2.txt','b2','-ascii')
save('SA1b3.txt','b3','-ascii')
save('SA1b4.txt','b4','-ascii')
save('SA1b5.txt','b5','-ascii')
save('SA1b6.txt','b6','-ascii')
save('SA1b7.txt','b7','-ascii')
save('SA1b8.txt','b8','-ascii')
save('SA1b9.txt','b9','-ascii')
save('SA1b10.txt','b10','-ascii')
save('SA1b11.txt','b11','-ascii')

save('SA1norm.txt', 'normFactor','-ascii')
% 
