...
RNC1s2 = net.outputs{(archLayer+1)}.processSettings{1};
...
save('RNC1structOW.mat', 'RNC1s2')

save('RNC1IW1.txt','IW','-ascii')
save('RNC1LW1.txt','LW','-ascii')
save('RNC1LW2.txt','LW2','-ascii')
save('RNC1LW3.txt','LW3','-ascii')
save('RNC1LW4.txt','LW4','-ascii')
save('RNC1LW5.txt','LW5','-ascii')
save('RNC1LW6.txt','LW6','-ascii')

save('RNC1b1.txt','b1','-ascii')
save('RNC1b2.txt','b2','-ascii')
save('RNC1b3.txt','b3','-ascii')
save('RNC1b4.txt','b4','-ascii')
save('RNC1b5.txt','b5','-ascii')
save('RNC1b6.txt','b6','-ascii')
save('RNC1b7.txt','b7','-ascii')

save('RNC1norm.txt', 'normFactor','-ascii')