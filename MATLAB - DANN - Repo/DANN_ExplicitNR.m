...
NRs2 = net.outputs{(archLayer+1)}.processSettings{1};
...
save('NRstructOW.mat', 'NRs2')

save('NRIW1.txt','IW','-ascii')
save('NRLW1.txt','LW','-ascii')
save('NRLW2.txt','LW2','-ascii')

save('NRb1.txt','b1','-ascii')
save('NRb2.txt','b2','-ascii')
save('NRb3.txt','b3','-ascii')

save('NRnorm.txt', 'normFactor','-ascii')
% 
