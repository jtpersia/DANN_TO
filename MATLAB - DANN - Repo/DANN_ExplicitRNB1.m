...
RNB1s2 = net.outputs{(archLayer+1)}.processSettings{1};
...
save('RNB1structOW.mat', 'RNB1s2')

save('RNB1IW1.txt','IW','-ascii')
save('RNB1LW1.txt','LW','-ascii')
save('RNB1LW2.txt','LW2','-ascii')
save('RNB1LW3.txt','LW3','-ascii')

save('RNB1b1.txt','b1','-ascii')
save('RNB1b2.txt','b2','-ascii')
save('RNB1b3.txt','b3','-ascii')
save('RNB1b4.txt','b4','-ascii')

save('RNB1norm.txt', 'normFactor','-ascii')