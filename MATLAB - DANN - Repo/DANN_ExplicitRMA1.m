...
RMA1s2 = net.outputs{(archLayer+1)}.processSettings{1};
...
save('RMA1structOW.mat', 'RMA1s2')

save('RMA1IW1.txt','IW','-ascii')
save('RMA1LW1.txt','LW','-ascii')
save('RMA1LW2.txt','LW2','-ascii')
save('RMA1LW3.txt','LW3','-ascii')
save('RMA1LW4.txt','LW4','-ascii')
save('RMA1LW5.txt','LW5','-ascii')
save('RMA1LW6.txt','LW6','-ascii')
save('RMA1LW7.txt','LW7','-ascii')
save('RMA1LW8.txt','LW8','-ascii')

save('RMA1b1.txt','b1','-ascii')
save('RMA1b2.txt','b2','-ascii')
save('RMA1b3.txt','b3','-ascii')
save('RMA1b4.txt','b4','-ascii')
save('RMA1b5.txt','b5','-ascii')
save('RMA1b6.txt','b6','-ascii')
save('RMA1b7.txt','b7','-ascii')
save('RMA1b8.txt','b8','-ascii')
save('RMA1b9.txt','b9','-ascii')

save('RMA1norm.txt', 'normFactor','-ascii')