...
RNMC1s2 = net.outputs{(archLayer+1)}.processSettings{1};
...
save('RNMC1structOW.mat', 'RNMC1s2')

save('RNMC1IW1.txt','IW','-ascii')
save('RNMC1LW1.txt','LW','-ascii')
save('RNMC1LW2.txt','LW2','-ascii')
save('RNMC1LW3.txt','LW3','-ascii')
save('RNMC1LW4.txt','LW4','-ascii')
save('RNMC1LW5.txt','LW5','-ascii')
save('RNMC1LW6.txt','LW6','-ascii')

save('RNMC1b1.txt','b1','-ascii')
save('RNMC1b2.txt','b2','-ascii')
save('RNMC1b3.txt','b3','-ascii')
save('RNMC1b4.txt','b4','-ascii')
save('RNMC1b5.txt','b5','-ascii')
save('RNMC1b6.txt','b6','-ascii')
save('RNMC1b7.txt','b7','-ascii')

save('RNMC1norm.txt', 'normFactor','-ascii')